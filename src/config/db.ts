...
const db = new Sequelize(process.env.DATABASE_URL!,{
  ...
  models: [__dirname + '/../models/**/*'], //esto es para decirle a sequelize que busque los modelos en la carpeta models, y que los cargue automaticamente, para poder usarlos en nuestra aplicacion
